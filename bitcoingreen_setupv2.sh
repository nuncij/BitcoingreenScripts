...
NAME="bitcoingreen"
NAMEALIAS="bitg"
URL="https://github.com/bitcoingreen/bitcoingreen/releases/download/v1.3.0/bitcoingreen-1.3.1-x86_64-linux-gnu.tar.gz"
WALLETDL="bitcoingreen-1.3.1-x86_64-linux-gnu.tar.gz"
WALLETDLFOLDER="bitcoingreen-1.3.1"
